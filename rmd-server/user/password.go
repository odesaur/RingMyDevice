...
// Sets the password-related field on the RMDUser.
//
...
//
// This function does NOT save the RMDUser to the database!
// This is the responsibility of the caller.
func (user *RMDUser) setPasswordData(saltInner string, innerPwHash string) {
